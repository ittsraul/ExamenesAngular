// To parse this data:
//
//   import { Convert, Ricky } from "./file";
//
//   const ricky = Convert.toRicky(json);
//
...
export class Convert {
    public static toRicky(json: string): Ricky {
        return cast(JSON.parse(json), r("Ricky"));
    }

    public static rickyToJson(value: Ricky): string {
        return JSON.stringify(uncast(value, r("Ricky")), null, 2);
    }
}
